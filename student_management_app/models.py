...
def create_user_profile(sender, instance, created, **kwargs):
    ...
    if created:
        # user_type is a CharField, but callers sometimes pass it as an int.
        # Normalize to string so both cases work.
        ...
        if user_type == "3":
            # Use the first available Course/Session as a placeholder
            # (the add_student view sets the real ones right after)
...
def save_user_profile(sender, instance, **kwargs):
    ...
    try:
        ...
        # Legacy users created without a profile row — nothing to sync
        pass
